// Eigen.cpp: implementation of the CEigen class.
//
//////////////////////////////////////////////////////////////////////
...
int CEigen::cvJacobiEigens_32f (float* A,float* V,float* E,int n,float  eps )
{
    int i, j, k, ind;
    float *AA = A, *VV = V;
...
int CEigen::cvJacobiEigens_64d(double* A,double* V,double* E,int     n,double  eps )
{
    int i, j, k, p, q, ind;
